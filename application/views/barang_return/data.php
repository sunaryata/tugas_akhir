                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    ...
                                    <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('barang/delete/') . $bk['id_barang_return'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                                <?php
