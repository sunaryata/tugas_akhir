        ...
        <div class="card shadow-sm border-bottom-dark">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <!-- <div class="input-group-append">
                                <a class="btn btn-danger" href="<?= base_url('jenis/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div> -->
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <!-- <div class="input-group-append">
                                <a class="btn btn-danger" href="<?= base_url('satuan/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div> -->
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('stok', $barang['stok']); ?>" name="stok" id="stok" type="text" class="form-control" placeholder="Nama Barang...">
