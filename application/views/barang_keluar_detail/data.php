...
<div class="card shadow-sm border-bottom-dark">
	<div class="card-header bg-white py-3">
		<div class="row">
			...
			<div class="col-auto">
				<a href="<?= base_url('barangkeluar/add_detail/' . $id_barang_keluar) ?>" class="btn btn-sm btn-primary btn-icon-split">
					<span class="icon">
						...
						<tr>
							...
							<td>
								...
								?>
									...
									<a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('barangkeluar/deleteitem/') . $bm['id_detail_barang_keluar'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
								<?php
								} elseif ($dataSession['role'] == "gudang" or $dataSession['role'] == "kasir") {
								?>
									<a href="<?= base_url('barangmasuk/edit/') . $bm['id_barang_keluar'] ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
								<?php
								} else {
								}
								?>
