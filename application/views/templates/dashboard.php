...
<head>
	...
	<title><?= $title; ?> | Sistem Monitoring Pengadaan Barang</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-primary sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
			...
			<li class="nav-item text-white">
				<a class="nav-link text-white text-white" href="<?= base_url('dashboard'); ?>">
			...
			<?php if (!is_kasir()) : ?>
				<li class="nav-item">
					<a class="nav-link text-white pb-0" href="<?= base_url('supplier'); ?>">
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link text-white pb-0" href="<?= base_url('barangmasuk'); ?>">
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link text-white" href="<?= base_url('barangkeluar'); ?>">
			...
			<li class="nav-item">
				<a class="nav-link text-white" href="<?= base_url('barangreturn'); ?>">
					<i class="fas fa-fw fa-upload"></i>
			...
			<footer class="sticky-footer bg-light">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>&copy; Aplikasi Inventory &bull; S-Cell Poncowinatan</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
	...
	<script type="text/javascript">
		...
		// let totalku = $('#total_stoku');
		// let total = $('#total_stok');
		let jumlah = hal == 'barangmasuk' ? $('#jumlah_masuk') : $('#jumlah_keluar');
		// let jumlah = hal == 'barangmasuk' ? $('#jumlah_masuk') : $('#jumlah_return') ;
		...
		$(document).on('change', '#barang_id', function() {
			...
			$.getJSON(url, function(data) {
				...
				stok.val(data.stok);
				// stoku.val(data.stoku);	
				total.val(data.stok);
				// totalku.val(data.stok);
				jumlah.focus();
			});
		});
