...
class Barang extends CI_Controller
{
    ...
    {
        // $sess = $this->session->userdata('login_session');
        // echo $sess['role'];
        // $sess = $this->session->userdata('role');
        // $data = $this->session->userdata('login_session','role');
        // $data = $this->db->get_where('user', ['role' => $this->session->userdata('login_session')])->row_array();
        // $data['data'] = $this->db->get_where('user', ['role' => $this->admin-->userdata('role')])->row_array();
        // $cek_username = $this->auth->cek_username($input['username']);
        // $data = $this->db->get_where('user', ['role' => $role])->row_array();
